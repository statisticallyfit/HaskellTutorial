...
/* package AlgebraicSimplifierProject-0.1.0.0 */
#ifndef VERSION_AlgebraicSimplifierProject
#define VERSION_AlgebraicSimplifierProject "0.1.0.0"
#endif /* VERSION_AlgebraicSimplifierProject */
#ifndef MIN_VERSION_AlgebraicSimplifierProject
#define MIN_VERSION_AlgebraicSimplifierProject(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_AlgebraicSimplifierProject */
...
#define CURRENT_PACKAGE_KEY "AlgebraicSimplifierProject-0.1.0.0-ANHatIiCQmUERKHJzhdyxL"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "AlgebraicSimplifierProject-0.1.0.0-ANHatIiCQmUERKHJzhdyxL"
