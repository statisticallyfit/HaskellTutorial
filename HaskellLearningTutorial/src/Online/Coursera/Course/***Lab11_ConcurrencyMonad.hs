...
instance Functor Concurrent where
    fmap f (Concurrent a) = Concurrent (f a)


instance Applicative Concurrent where
    pure = Concurrent
    (<*>) (Concurrent f) (Concurrent a) = Concurrent (f a)
...
http://www.seas.upenn.edu/~cis552/11fa/lectures/concurrency.html
-}